...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Ets', fields ['fecha', 'hora', 'evaluador']
        db.create_unique(u'principal_ets', ['fecha', 'hora', 'evaluador_id'])

        # Adding unique constraint on 'Ets', fields ['salon', 'fecha', 'hora']
        db.create_unique(u'principal_ets', ['salon_id', 'fecha', 'hora'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Ets', fields ['salon', 'fecha', 'hora']
        db.delete_unique(u'principal_ets', ['salon_id', 'fecha', 'hora'])

        # Removing unique constraint on 'Ets', fields ['fecha', 'hora', 'evaluador']
        db.delete_unique(u'principal_ets', ['fecha', 'hora', 'evaluador_id'])
