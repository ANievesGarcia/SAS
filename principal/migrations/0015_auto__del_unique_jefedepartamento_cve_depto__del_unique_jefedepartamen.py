...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'JefeDepartamento', fields ['cve_prof']
        db.delete_unique(u'principal_jefedepartamento', ['cve_prof_id'])

        # Removing unique constraint on 'JefeDepartamento', fields ['cve_depto']
        db.delete_unique(u'principal_jefedepartamento', ['cve_depto_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'JefeDepartamento', fields ['cve_depto']
        db.create_unique(u'principal_jefedepartamento', ['cve_depto_id'])

        # Adding unique constraint on 'JefeDepartamento', fields ['cve_prof']
        db.create_unique(u'principal_jefedepartamento', ['cve_prof_id'])
    ...
    models = {
        ...
        u'principal.jefedepartamento': {
            ...
            'cve_depto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['principal.Depto']"}),
            'cve_prof': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['principal.Profesor']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
