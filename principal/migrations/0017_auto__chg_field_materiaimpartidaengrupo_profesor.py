...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MateriaImpartidaEnGrupo.profesor'
        db.alter_column(u'principal_materiaimpartidaengrupo', 'profesor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['principal.Profesor'], null=True))

    def backwards(self, orm):

        # Changing field 'MateriaImpartidaEnGrupo.profesor'
        db.alter_column(u'principal_materiaimpartidaengrupo', 'profesor_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['principal.Profesor']))
