...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Horario', fields ['lunes']
        db.create_unique(u'principal_horario', ['lunes'])

        # Adding unique constraint on 'Horario', fields ['miercoles']
        db.create_unique(u'principal_horario', ['miercoles'])

        # Adding unique constraint on 'Horario', fields ['jueves']
        db.create_unique(u'principal_horario', ['jueves'])

        # Adding unique constraint on 'Horario', fields ['martes']
        db.create_unique(u'principal_horario', ['martes'])

        # Adding unique constraint on 'Horario', fields ['viernes']
        db.create_unique(u'principal_horario', ['viernes'])


    def backwards(self, orm):
        # Removing unique constraint on 'Horario', fields ['viernes']
        db.delete_unique(u'principal_horario', ['viernes'])

        # Removing unique constraint on 'Horario', fields ['martes']
        db.delete_unique(u'principal_horario', ['martes'])

        # Removing unique constraint on 'Horario', fields ['jueves']
        db.delete_unique(u'principal_horario', ['jueves'])

        # Removing unique constraint on 'Horario', fields ['miercoles']
        db.delete_unique(u'principal_horario', ['miercoles'])

        # Removing unique constraint on 'Horario', fields ['lunes']
        db.delete_unique(u'principal_horario', ['lunes'])
    ...
    models = {
        ...
        u'principal.ets': {
            'Meta': {'ordering': "('cve_materia',)", 'unique_together': "(('cve_materia', 'turno'), ('salon', 'fecha', 'hora'), ('fecha', 'hora', 'evaluador'))", 'object_name': 'Ets'},
        ...
        u'principal.horario': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jueves': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'lunes': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'martes': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'miercoles': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'viernes': ('django.db.models.fields.CharField', [], {'default': "'-'", 'max_length': '20', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'principal.materiaimpartidaengrupo': {
            'Meta': {'unique_together': "(('materia', 'grupo'), ('grupo', 'horario'), ('profesor', 'horario'))", 'object_name': 'MateriaImpartidaEnGrupo'},
            ...
            'profesor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['principal.Profesor']", 'null': 'True', 'blank': 'True'})
        },
