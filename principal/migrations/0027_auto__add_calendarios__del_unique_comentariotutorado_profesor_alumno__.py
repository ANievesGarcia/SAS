...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'principal_calendarios', (
            ...
            ('inicperiodo', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('finperiodo', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('periodo', self.gf('django.db.models.fields.CharField')(max_length=6, null=True)),
