...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Laboratorio.equipo'
        db.delete_column(u'principal_laboratorio', 'equipo_id')

        # Adding field 'Equipos.laboratorio'
        db.add_column(u'principal_equipos', 'laboratorio',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['principal.Laboratorio']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Laboratorio.equipo'
        db.add_column(u'principal_laboratorio', 'equipo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['principal.Equipos'], unique=True),
                      keep_default=False)

        # Deleting field 'Equipos.laboratorio'
        db.delete_column(u'principal_equipos', 'laboratorio_id')
