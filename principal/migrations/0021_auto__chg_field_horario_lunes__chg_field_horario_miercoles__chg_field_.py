...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Horario.lunes'
        db.alter_column(u'principal_horario', 'lunes', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Horario.miercoles'
        db.alter_column(u'principal_horario', 'miercoles', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Horario.jueves'
        db.alter_column(u'principal_horario', 'jueves', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Horario.martes'
        db.alter_column(u'principal_horario', 'martes', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Horario.viernes'
        db.alter_column(u'principal_horario', 'viernes', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Horario.lunes'
        db.alter_column(u'principal_horario', 'lunes', self.gf('django.db.models.fields.CharField')(default=0, max_length=20))

        # Changing field 'Horario.miercoles'
        db.alter_column(u'principal_horario', 'miercoles', self.gf('django.db.models.fields.CharField')(default=0, max_length=20))

        # Changing field 'Horario.jueves'
        db.alter_column(u'principal_horario', 'jueves', self.gf('django.db.models.fields.CharField')(default=0, max_length=20))

        # Changing field 'Horario.martes'
        db.alter_column(u'principal_horario', 'martes', self.gf('django.db.models.fields.CharField')(default=0, max_length=20))

        # Changing field 'Horario.viernes'
        db.alter_column(u'principal_horario', 'viernes', self.gf('django.db.models.fields.CharField')(default=0, max_length=20))
