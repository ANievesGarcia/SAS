...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Laboratorio.nombre'
        db.delete_column(u'principal_laboratorio', 'nombre')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Laboratorio.nombre'
        db.add_column(u'principal_laboratorio', 'nombre',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=30, unique=True, db_index=True),
                      keep_default=False)
