...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MateriaImpartidaEnGrupo', fields ['profesor', 'horario']
        db.create_unique(u'principal_materiaimpartidaengrupo', ['profesor_id', 'horario_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MateriaImpartidaEnGrupo', fields ['profesor', 'horario']
        db.delete_unique(u'principal_materiaimpartidaengrupo', ['profesor_id', 'horario_id'])
